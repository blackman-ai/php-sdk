...
class Usage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['completion_tokens'] < 0)) {
            $invalidProperties[] = "invalid value for 'completion_tokens', must be bigger than or equal to 0.";
        }

        if ($this->container['prompt_tokens'] === null) {
            $invalidProperties[] = "'prompt_tokens' can't be null";
        }
        if (($this->container['prompt_tokens'] < 0)) {
            $invalidProperties[] = "invalid value for 'prompt_tokens', must be bigger than or equal to 0.";
        }

        if ($this->container['total_tokens'] === null) {
            $invalidProperties[] = "'total_tokens' can't be null";
        }
        if (($this->container['total_tokens'] < 0)) {
     ...
     *
     * @param int $completion_tokens completion_tokens
     *
     * @return self
     */
    public function setCompletionTokens($completion_tokens)
    {
        ...
        if (($completion_tokens < 0)) {
            throw new \InvalidArgumentException('invalid value for $completion_tokens when calling Usage., must be bigger than or equal to 0.');
        }
     ...
     * Sets prompt_tokens
     *
     * @param int $prompt_tokens prompt_tokens
     *
     * @return self
     */
    public function setPromptTokens($prompt_tokens)
    {
        ...
        if (($prompt_tokens < 0)) {
            throw new \InvalidArgumentException('invalid value for $prompt_tokens when calling Usage., must be bigger than or equal to 0.');
        }
    ...
    public function setTotalTokens($total_tokens)
    {
        ...
        if (($total_tokens < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_tokens when calling Usage., must be bigger than or equal to 0.');
        }
