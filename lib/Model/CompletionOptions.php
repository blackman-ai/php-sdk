...
/**
 * CompletionOptions Class Doc Comment
 *
 * @category Class
 * @package  BlackmanClient
 * @author   OpenAPI Generator team
 ...
 */
class CompletionOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CompletionOptions';
    ...
    */
    ...
    public function setMaxTokens($max_tokens)
    {
        ...
        if (!is_null($max_tokens) && ($max_tokens < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_tokens when calling CompletionOptions., must be bigger than or equal to 0.');
        }
