...
class SubmitFeedbackRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubmitFeedbackRequest';
    ...
    {
        $this->setIfExists('is_positive', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_positive'] === null) {
            $invalidProperties[] = "'is_positive' can't be null";
        }
     ...
     * Sets is_positive
     *
     * @param bool $is_positive True for thumbs up, false for thumbs down
     *
     * @return self
     */
    public function setIsPositive($is_positive)
    {
        if (is_null($is_positive)) {
            throw new \InvalidArgumentException('non-nullable is_positive cannot be null');
        }
     ...
     * Sets metadata
     *
     * @param object|null $metadata Optional metadata (e.g., user_agent, session_id, etc.)
     *
     * @return self
     */
     ...
     * Sets response_id
     *
     * @param string $response_id The response ID from the completion request
     *
     * @return self
     */
