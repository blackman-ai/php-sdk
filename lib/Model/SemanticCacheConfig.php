...
/**
 * SemanticCacheConfig Class Doc Comment
 *
 * @category Class
 * @package  BlackmanClient
 * @author   OpenAPI Generator team
 ...
 */
class SemanticCacheConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SemanticCacheConfig';
    ...
    protected static $setters = [
        'enabled' => 'setEnabled',
        'similarity_threshold' => 'setSimilarityThreshold',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('similarity_threshold', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['similarity_threshold'] === null) {
            $invalidProperties[] = "'similarity_threshold' can't be null";
        }
     ...
     * Sets enabled
     *
     * @param bool $enabled Whether semantic caching is enabled
     *
     * @return self
     */
    ...
    /**
     * Gets similarity_threshold
     *
     * @return float
     */
    public function getSimilarityThreshold()
    {
        return $this->container['similarity_threshold'];
    }

    /**
     * Sets similarity_threshold
     *
     * @param float $similarity_threshold Similarity threshold for cache hits (0.0-1.0)
     *
     * @return self
     */
    public function setSimilarityThreshold($similarity_threshold)
    {
        if (is_null($similarity_threshold)) {
            throw new \InvalidArgumentException('non-nullable similarity_threshold cannot be null');
        }
        $this->container['similarity_threshold'] = $similarity_threshold;
     ...
     * Sets ttl_seconds
     *
     * @param int $ttl_seconds Time-to-live for cache entries in seconds
     *
     * @return self
     */
